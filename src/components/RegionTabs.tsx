  ...
  return (
    <div className="mb-5">
      <div className="mb-2.5 flex items-center justify-between">
        <span className="mono-label">エリア</span>
      </div>
      <LayoutGroup id="region-tabs">
        <div
          ...
          aria-label="エリア"
          className={
            "no-scrollbar -mx-5 flex gap-2 overflow-x-auto px-5 sm:-mx-8 sm:px-8 " +
          ...
          {REGIONS.map((r) => {
            ...
            return (
              <motion.button
                ...
                className={
                  "relative flex shrink-0 items-center gap-2 rounded-lg border px-4 py-2.5 text-[15px] font-medium tracking-tight transition-colors duration-300 " +
                  (isActive
              ...
              >
                ...
                <span className="relative z-10 font-mono text-[11px] font-bold uppercase tracking-[0.1em] opacity-80">
                  {CODES[r.id]}
                </span>
                <span className="relative z-10">{LABEL[r.id]}</span>
                {count > 0 && (
                  <span
                    className={
                      "relative z-10 tabular-nums font-mono text-[12px] font-medium " +
